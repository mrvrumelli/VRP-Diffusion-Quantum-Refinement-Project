...
def solve_instances(
    ...
    *,
    ...
    """Solve a set of instances; labelled examples also get a gap against their reference cost."""
...
def summarize_solutions(solutions: Sequence[InstanceSolution]) -> dict[str, float]:
