...
from vrp_diffusion_quantum.inference.predict_matrix import PredictionMode, predict_matrix_batch
...
def select_validation_threshold(
    ...
    *,
    ...
    if mode == "full_chain":
        return 0.5
    probabilities, _ = predict_matrix_batch(
        model,
        schedule,
        selection_examples,
        mode=mode,
...
def evaluate_generalization_case(
    ...
    *,
    ...
    probabilities, hard_matrices = predict_matrix_batch(
        model,
        schedule,
        case.examples,
        mode=mode,
